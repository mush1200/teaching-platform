...
| 11 | Buyer Payment Deadline | `payment_due_at`、逾期處理、逾期付款處理、consent 版本處置（不復活） | **NOT IMPLEMENTED** | — |
| 12 | Legal Information Read & Save | §18 資訊可**完整查閱並儲存**（下載／列印／複製全文） | **NOT IMPLEMENTED** | 無 `/terms`／`/privacy` route |
...
**Deployment Readiness： 0 / 14 IMPLEMENTED（Gate 1、2、3、5、6、7、14 為 PARTIAL）。**
