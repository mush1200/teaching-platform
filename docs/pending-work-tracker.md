...
>
>   接下來**唯一**擋住正式上線的是 External Dependency：
>     1  **Legal**   —— 法律文件與相關結論（`L-*`／`P1-09`／`SEC-03 (b)`）
>     2  **Domain**  —— 正式網域
>
>   非阻擋、維持現狀，**本輪不解除**：
