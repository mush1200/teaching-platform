...
#### (E) Owner 決定 12 項 —— **2026-09-13 已答 7 項**（`DEC-20` ×5；**#2 由 `DEC-22` ＋ `DEC-23`**；**#1 由 `DEC-24`**）、**1 項部分決定**（#6 —— `DEC-21`）、**4 項全未決**（#3／#5／#7／#12）
...
| 3 | 結算週期：逐筆／每週／每月／其他 | ❌ **未定** | **OWNER**（營運） |
...
| 7 | 撥款時點與退款／解除權期間的關係 | ❌ **未定** | **OWNER ＋ LAWYER**（與 `L-09`／Refund 併同） |
