...
#### (E) Owner 決定 12 項 —— **2026-09-13 已答 8 項**（`DEC-20` ×5；**#2 由 `DEC-22` ＋ `DEC-23`**；**#1 由 `DEC-24`**；**#3 由 `DEC-25`**）、**2 項部分決定**（#6 —— `DEC-21`；#7 —— `DEC-25` 營運面）、**2 項全未決**（#5／#12）
