...
### 1.6.0-I MVP launch scope 擴大（2026-09-13，`DEC-18` / `DEC-19`）—— 盤點與計畫，**未實作**
...
#### (E) Owner 決定 12 項 —— **2026-09-13 已答 5 項（`DEC-20`），仍缺 7 項**

| # | 題目 | 狀態 | 性質 |
| --- | --- | --- | --- |
| 1 | 平台抽成比例 | ❌ **未定** | **OWNER**（純商業） |
| 2 | 折扣／促銷由誰承擔（含訂單層級分攤規則） | ❌ **未定** | **OWNER ＋ ACCOUNTANT**（`AD-13`） |
| 3 | 結算週期：逐筆／每週／每月／其他 | ❌ **未定** | **OWNER**（營運） |
| 4 | 撥款方式 | ✅ **人工銀行匯款**（`DEC-20`） | **OWNER**。⚠️ 平台**不自動移動金錢**；此事實與 `AD-10` 相關但**不構成**對它的回答 |
| 5 | 最低撥款門檻 | ❌ **未定** | **OWNER**（營運） |
| 6 | 退款處理：向後扣抵／回沖／已撥款後如何處理 | ❌ **未定** | **OWNER ＋ LAWYER ＋ ACCOUNTANT**（`AD-12`） |
