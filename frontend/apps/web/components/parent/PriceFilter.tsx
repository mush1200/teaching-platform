...
export function PriceFilter({ mode, onModeChange, priceMin, priceMax, onPriceMinChange, onPriceMaxChange }: Props) {
  ...
  return (
    <div className="space-y-2">
      <p className="text-xs font-semibold text-ds-textMuted">價格</p>
        ...
        <div className="flex flex-wrap items-end gap-2">
          <div>
            ...
            <input
              ...
              className="w-24 rounded-lg border border-ds-borderControl px-2 py-1.5 text-sm"
            />
          </div>
          <span className="text-ds-textSubtle">—</span>
          <div>
