  ...
  return (
    <div className="min-w-[140px]">
      ...
      <select
        ...
        className="w-full rounded-xl border border-ds-borderControl bg-white px-3 py-2 text-sm font-medium text-[#1F2937] shadow-sm focus-visible:border-ds-focus focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ds-focus"
      >
        {OPTIONS.map((o) => (
